...
namespace GabSoftware.Utils
{
    ...
    public class GabKeyboardHook
    {
        ...
        private const byte VK_LWIN      = 0x52;
        ...
        /// </remarks>
        public GabKeyboardHook(bool InstallKeyboardHook)
        {
        ...
        /// <summary>
        /// Installs keyboard hooks and starts raising events
        /// </summary>
        /// <exception cref="Win32Exception">Any windows problem.</exception>
        public void Start()
        {
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && ((KeyDown != null) || (KeyUp != null)))
            {
                ...
                if (KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                {
                    ...
                    keyData |= ((GetAsyncKeyState(VK_SHIFT) & 0x8000) == 0x8000 ? Keys.Shift : Keys.None);
                    
                    //Touche Control pressée
                    keyData |= ((GetAsyncKeyState(VK_CONTROL) & 0x8000) == 0x8000 ? Keys.Control : Keys.None);
                    
                    //Touche Alt pressée
                    keyData |= ((GetAsyncKeyState(VK_MENU) & 0x8000) == 0x8000 ? Keys.Alt : Keys.None);

                    //Touche Windows gauche pressée
                    keyData |= ((GetAsyncKeyState(VK_LWIN) & 0x8000) == 0x8000 ? Keys.LWin : Keys.None);
                ...
                else if (KeyUp != null && (wParam == WM_KEYUP || wParam == WM_SYSKEYUP)) // raises KeyUp
                {
                    Keys keyData = (Keys)MyKeyboardHookStruct.vkCode;
                    KeyEventArgs e;
